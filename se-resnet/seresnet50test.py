...
class UNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.encoder = timm.create_model('seresnet50', pretrained=False, features_only=True, out_indices=(0, 1, 2, 3, 4))
...
def test_new_images(model, image_paths, ground_truth_paths=None, img_size=(256, 256), save_folder='seresnetimg/seresnet50'):
    model.to(device)
    model.eval()
...
weights_path = "best_weights_seresnet50.pth"  # Ensure you have the correct weights file
...
test_new_images(model, new_image_paths, ground_truth_paths, save_folder='seresnetimg/seresnet50')
