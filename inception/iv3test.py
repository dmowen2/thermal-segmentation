...
class UNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.encoder = models.inception_v3(weights=models.Inception_V3_Weights.IMAGENET1K_V1, aux_logits=True)
...
weights_path = "best_weights_inceptionv3.pth"  # Ensure you have the correct weights file
...
test_new_images(model, new_image_paths, ground_truth_paths, save_folder='inceptionimg/inceptionv3')
