...
class UNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.encoder = timm.create_model('tf_efficientnet_b2', pretrained=True, features_only=True, out_indices=(0, 1, 2, 3, 4))
        ...
        self.decoder = nn.Sequential(
            nn.ConvTranspose2d(352, 256, kernel_size=2, stride=2, padding=1),
            nn.ReLU(),
...
weights_path = "best_weights_effnetb2.pth"  # Ensure you have the correct weights file
...
test_new_images(model, new_image_paths, ground_truth_paths, save_folder='effnetimg/effnetb2')
