...
class UNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.encoder = timm.create_model('vgg19', pretrained=True, features_only=True, out_indices=(4,))
...
weights_path = "best_weights_vgg19.pth"  # Ensure you have the correct weights file
...
test_new_images(model, new_image_paths, ground_truth_paths, save_folder='vggimg/vgg19')
