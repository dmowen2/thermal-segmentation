...
class UNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.encoder = timm.create_model('inception_resnet_v2', pretrained=True, features_only=True, out_indices=(1, 2, 3, 4))
        ...
        self.decoder = nn.Sequential(
            nn.ConvTranspose2d(1536, 1024, kernel_size=2, stride=2),
            nn.ReLU(),
...
weights_path = "best_weights_inceptionv2.pth"  # Ensure you have the correct weights file
...
test_new_images(model, new_image_paths, ground_truth_paths, save_folder='inceptionimg/inceptionv2')
