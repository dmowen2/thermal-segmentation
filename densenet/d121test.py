...
class UNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.encoder = models.densenet121(weights=models.DenseNet121_Weights.IMAGENET1K_V1)
...
weights_path = "best_weights_densenet121.pth"  # Ensure you have the correct weights file
...
test_new_images(model, new_image_paths, ground_truth_paths, save_folder='densenetimg/densenet121')
