...
class UNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.encoder = timm.create_model('tf_efficientnet_b1', pretrained=True, features_only=True, out_indices=(0, 1, 2, 3, 4))
...
weights_path = "best_weights_effnetb1.pth"  # Ensure you have the correct weights file
...
test_new_images(model, new_image_paths, ground_truth_paths, save_folder='effnetimg/effnetb1')
