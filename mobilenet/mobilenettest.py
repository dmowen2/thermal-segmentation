...
weights_path = "best_weights_mobilenet.pth"  # Ensure you have the correct weights file
...
test_new_images(model, new_image_paths, ground_truth_paths, save_folder='mobilenetimg/mobilenet')
